...
This template can be used as is but, its intended as a quick start for the students learning the ESP32-IDF through the course [https://learnesp32.com](https://learnesp32.com)

## prerequisites

1. You will need to have [node](https://nodejs.org) installed.
2. The esp-idf must be set up. you can follow the instructions in the course (free of charge) on the [Setting up Your Environment](https://learnesp32.com/videos/course-introduction/course-introduction) module or follow the [official documentation](https://docs.espressif.com/projects/esp-idf/en/latest/get-started/#step-1-set-up-the-toolchain)
